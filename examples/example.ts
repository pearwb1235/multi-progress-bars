...
const testBasic = async (anchor: Anchor) => {
  ...
  timeoutId = setTimeout(() => {
    mpb.done(taskInf, {
      message: "Linting finished. Output in eslint-output.txt",
    });
    timeoutId = setTimeout(() => {
...
(async () => {
  ...
  if (
    process.argv.includes("--overflow") ||
